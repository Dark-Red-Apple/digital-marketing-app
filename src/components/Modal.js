...
function Modal({ isOpen, setIsOpen, setModalType, modalType, children }) {
  ...
  return (
    <motion.section className="dma-modal p-lg-5 p-1" initial={{ opacity: 0 }} animate={isOpen ? "open" : "hidden"} variants={variants}>
      <motion.div className="dma-modal__content p-lg-5 p-1 py-5 py-md-1 d-flex justify-content-center align-items-self-start" animate={isOpen ? "open" : "hidden"} variants={scaleVariants}>
